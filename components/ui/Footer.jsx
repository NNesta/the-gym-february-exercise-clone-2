...
const Footer = () => {
  return (
    <div className="border-t-2 border-primary py-6 mt-12">
      <Wrapper>
        <div className="grid lg:grid-cols-4 gap-6 justify-between py-6 border-b-2 border-primary">
          <div>
            <Logo />
            ...
            <div className="flex gap-4">
              {[
                "https://www.aalto.fi/themes/custom/aalto_aaltofi/images/icons.svg#24-facebook-dark",
                "https://www.aalto.fi/themes/custom/aalto_aaltofi/images/icons.svg#24-linkedin-dark",
                "https://www.aalto.fi/themes/custom/aalto_aaltofi/images/icons.svg#24-twitter-dark",
                "https://www.aalto.fi/themes/custom/aalto_aaltofi/images/icons.svg#24-instagram-dark",
                "https://www.aalto.fi/themes/custom/aalto_aaltofi/images/icons.svg#24-youtube-dark",
                "https://www.aalto.fi/themes/custom/aalto_aaltofi/images/icons.svg#24-snapchat-dark",
                "https://www.aalto.fi/themes/custom/aalto_aaltofi/images/icons.svg#24-pencil-dark",
              ].map((item, index) => (
                <img
                  className="w-8 aspect-square rounded-full hover:bg-[#e3e3e3]"
                  key={index}
                  src={item}
                  alt=""
                  srcset=""
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between mt-4">
          <ul className="flex flex-col lg:flex-row gap-2">
            {[
              ...
              <li key={index}>
                <Link href={item.link} className="hover:bg-[#e3e3e3]">
                  {item.title}
                </Link>
              </li>
            ))}
